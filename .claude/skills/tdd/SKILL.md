...
2. The test must:
   - Describe the behavior in its name: `MethodName_StateUnderTest_ExpectedBehavior`
...
1. Look for: duplication, unclear names, methods doing too much, magic values
...
- **Don't mock what you own.** If you need to mock your own code to test it, the code needs restructuring. Mock only at system boundaries (external services, `DbContext`).
